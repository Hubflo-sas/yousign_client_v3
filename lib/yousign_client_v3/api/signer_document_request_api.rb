...
module YousignClientV3
  class SignerDocumentRequestApi
    ...
    def delete_signature_requests_signature_request_id_document_requests_document_request_id_with_http_info(signature_request_id, document_request_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/document_requests/{documentRequestId}'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'documentRequestId' + '}', document_request_id.to_s)
    ...
    def delete_signature_requests_signature_request_id_document_requests_document_request_id_signers_signer_id_with_http_info(signature_request_id, document_request_id, signer_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/document_requests/{documentRequestId}/signers/{signerId}'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'documentRequestId' + '}', document_request_id.to_s).sub('{' + 'signerId' + '}', signer_id.to_s)
    ...
    def delete_signature_requests_signature_request_id_signers_signer_id_documents_with_http_info(signature_request_id, signer_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/signers/{signerId}/documents'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'signerId' + '}', signer_id.to_s)
    ...
    def get_signature_requests_signature_request_id_signer_document_requests_with_http_info(signature_request_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/document_requests'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s)
      ...
      return_type = opts[:return_type] || 'GetSignatureRequestsSignatureRequestIdSignerDocumentRequests200Response' 
    ...
    def get_signature_requests_signature_request_id_signers_signer_id_documents_with_http_info(signature_request_id, signer_id, opts = {})
      ...
      return_type = opts[:return_type] || 'GetSignatureRequestsSignatureRequestIdSignersSignerIdDocuments200Response' 
    ...
    def get_signature_requests_signature_request_id_signers_signer_id_documents_signer_document_id_with_http_info(signature_request_id, signer_id, signer_document_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/signers/{signerId}/documents/{signerDocumentId}/download'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'signerId' + '}', signer_id.to_s).sub('{' + 'signerDocumentId' + '}', signer_document_id.to_s)
    ...
    def post_signature_requests_signature_request_id_document_requests_with_http_info(signature_request_id, opts = {})
      ...
      return_type = opts[:return_type] || 'SignerDocumentRequest' 
