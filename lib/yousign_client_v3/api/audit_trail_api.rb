...
module YousignClientV3
  class AuditTrailApi
    ...
    def get_signature_requests_signature_request_id_signers_signer_id_audit_trails_with_http_info(signature_request_id, signer_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/signers/{signerId}/audit_trails'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'signerId' + '}', signer_id.to_s)
      ...
      return_type = opts[:return_type] || 'SignerAuditTrail' 
    ...
    def get_signers_signer_id_audit_trails_download_with_http_info(signature_request_id, signer_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/signers/{signerId}/audit_trails/download'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'signerId' + '}', signer_id.to_s)
