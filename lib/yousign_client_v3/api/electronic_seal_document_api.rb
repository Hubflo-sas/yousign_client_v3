...
module YousignClientV3
  class ElectronicSealDocumentApi
    ...
    def download_electronic_seal_document_with_http_info(electronic_seal_document_id, opts = {})
      ...
      # resource path
      local_var_path = '/electronic_seal_documents/{electronicSealDocumentId}/download'.sub('{' + 'electronicSealDocumentId' + '}', electronic_seal_document_id.to_s)
    ...
    def upload_electronic_seal_document_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ElectronicSealDocument' 
