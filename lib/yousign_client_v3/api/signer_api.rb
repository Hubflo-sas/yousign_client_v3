...
module YousignClientV3
  class SignerApi
    ...
    def delete_signature_requests_signature_request_id_signers_signer_id_with_http_info(signature_request_id, signer_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/signers/{signerId}'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'signerId' + '}', signer_id.to_s)
    ...
    def post_signature_requests_signature_request_id_signers_signer_id_send_otp_with_http_info(signature_request_id, signer_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/signers/{signerId}/send_otp'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'signerId' + '}', signer_id.to_s)
    ...
    def post_signature_requests_signature_request_id_signers_signer_id_send_reminder_with_http_info(signature_request_id, signer_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/signers/{signerId}/send_reminder'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'signerId' + '}', signer_id.to_s)
    ...
    def post_signature_requests_signature_request_id_signers_signer_id_sign_with_http_info(signature_request_id, signer_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/signers/{signerId}/sign'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'signerId' + '}', signer_id.to_s)
      ...
      form_params['consent_given_at'] = opts[:'consent_given_at'] if !opts[:'consent_given_at'].nil?
      form_params['signature_image'] = opts[:'signature_image'] if !opts[:'signature_image'].nil?
