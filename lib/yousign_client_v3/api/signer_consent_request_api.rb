...
module YousignClientV3
  class SignerConsentRequestApi
    ...
    def delete_signature_requests_signature_request_id_consent_requests_consent_request_id_with_http_info(signature_request_id, consent_request_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/consent_requests/{consentRequestId}'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'consentRequestId' + '}', consent_request_id.to_s)
    ...
    def delete_signature_requests_signature_request_id_consent_requests_consent_request_id_signers_signer_id_with_http_info(signature_request_id, consent_request_id, signer_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/consent_requests/{consentRequestId}/signers/{signerId}'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s).sub('{' + 'consentRequestId' + '}', consent_request_id.to_s).sub('{' + 'signerId' + '}', signer_id.to_s)
    ...
    def get_signature_requests_signature_request_id_signer_consent_requests_with_http_info(signature_request_id, opts = {})
      ...
      # resource path
      local_var_path = '/signature_requests/{signatureRequestId}/consent_requests'.sub('{' + 'signatureRequestId' + '}', signature_request_id.to_s)
      ...
      return_type = opts[:return_type] || 'GetSignatureRequestsSignatureRequestIdSignerConsentRequests200Response' 
    ...
    def patch_signature_requests_signature_request_id_consent_requests_consent_request_id_with_http_info(signature_request_id, consent_request_id, opts = {})
      ...
      return_type = opts[:return_type] || 'SignerConsentRequest' 
