...
module YousignClientV3
  ...
  class Signer
    ...
    def list_invalid_properties
      ...
      if @identification_attestation_id.nil?
        invalid_properties.push('invalid value for "identification_attestation_id", identification_attestation_id cannot be nil.')
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('Object', ['initiated', 'declined', 'notified', 'verified', 'processing', 'consent_given', 'signed', 'aborted', 'error'])
      ...
      return false if @identification_attestation_id.nil?
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Object', ['initiated', 'declined', 'notified', 'verified', 'processing', 'consent_given', 'signed', 'aborted', 'error'])
