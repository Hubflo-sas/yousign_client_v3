...
# Unit tests for YousignClientV3::SignatureRequestSignerFromInfoInput
...
describe 'SignatureRequestSignerFromInfoInput' do
  ...
  describe 'test an instance of SignatureRequestSignerFromInfoInput' do
    it 'should create an instance of SignatureRequestSignerFromInfoInput' do
      expect(@instance).to be_instance_of(YousignClientV3::SignatureRequestSignerFromInfoInput)
    end
  end
