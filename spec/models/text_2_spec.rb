...
# Unit tests for YousignClientV3::Text2
...
describe 'Text2' do
  ...
  describe 'test an instance of Text2' do
    it 'should create an instance of Text2' do
      expect(@instance).to be_instance_of(YousignClientV3::Text2)
    end
  end
