...
# Unit tests for YousignClientV3::FromScratch1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FromScratch1' do
  before do
  ...
  describe 'test an instance of FromScratch1' do
    it 'should create an instance of FromScratch1' do
      expect(@instance).to be_instance_of(YousignClientV3::FromScratch1)
    end
  end
