...
# Unit tests for YousignClientV3::SignatureRequestPlaceholderSignerSubstituteFromInfoInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignatureRequestPlaceholderSignerSubstituteFromInfoInput' do
  before do
  ...
  describe 'test an instance of SignatureRequestPlaceholderSignerSubstituteFromInfoInput' do
    it 'should create an instance of SignatureRequestPlaceholderSignerSubstituteFromInfoInput' do
      expect(@instance).to be_instance_of(YousignClientV3::SignatureRequestPlaceholderSignerSubstituteFromInfoInput)
    end
  end
