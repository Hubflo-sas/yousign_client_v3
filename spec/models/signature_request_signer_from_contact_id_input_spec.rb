...
# Unit tests for YousignClientV3::SignatureRequestSignerFromContactIdInput
...
describe 'SignatureRequestSignerFromContactIdInput' do
  ...
  describe 'test an instance of SignatureRequestSignerFromContactIdInput' do
    it 'should create an instance of SignatureRequestSignerFromContactIdInput' do
      expect(@instance).to be_instance_of(YousignClientV3::SignatureRequestSignerFromContactIdInput)
    end
  end
