...
# Unit tests for YousignClientV3::User
...
describe 'User' do
  ...
  describe 'test an instance of User' do
    it 'should create an instance of User' do
      expect(@instance).to be_instance_of(YousignClientV3::User)
    end
  end
  ...
  describe 'test attribute "source"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["app", "public_api"])
