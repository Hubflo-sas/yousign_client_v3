...
# Unit tests for YousignClientV3::UpdateSigner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateSigner' do
  before do
  ...
  describe 'test an instance of UpdateSigner' do
    it 'should create an instance of UpdateSigner' do
      expect(@instance).to be_instance_of(YousignClientV3::UpdateSigner)
    end
  end
