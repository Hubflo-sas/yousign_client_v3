...
# Unit tests for YousignClientV3::SignatureRequestSignerFromUserIdInput
...
describe 'SignatureRequestSignerFromUserIdInput' do
  ...
  describe 'test an instance of SignatureRequestSignerFromUserIdInput' do
    it 'should create an instance of SignatureRequestSignerFromUserIdInput' do
      expect(@instance).to be_instance_of(YousignClientV3::SignatureRequestSignerFromUserIdInput)
    end
  end
