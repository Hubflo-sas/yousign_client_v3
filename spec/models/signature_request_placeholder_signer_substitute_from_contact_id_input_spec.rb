...
# Unit tests for YousignClientV3::SignatureRequestPlaceholderSignerSubstituteFromContactIdInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignatureRequestPlaceholderSignerSubstituteFromContactIdInput' do
  before do
  ...
  describe 'test an instance of SignatureRequestPlaceholderSignerSubstituteFromContactIdInput' do
    it 'should create an instance of SignatureRequestPlaceholderSignerSubstituteFromContactIdInput' do
      expect(@instance).to be_instance_of(YousignClientV3::SignatureRequestPlaceholderSignerSubstituteFromContactIdInput)
    end
  end
