...
# Unit tests for YousignClientV3::FromExistingUser1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FromExistingUser1' do
  before do
  ...
  describe 'test an instance of FromExistingUser1' do
    it 'should create an instance of FromExistingUser1' do
      expect(@instance).to be_instance_of(YousignClientV3::FromExistingUser1)
    end
  end
